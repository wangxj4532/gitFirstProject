...
public class ComFile {
	...
	public ComFile(String g_id, String cus_num, String g_class, String g_bill,
			String g_name, String g_unit, String g_weight, String g_length,
			String g_width, String g_height, String g_packamount,
			String g_standard, String g_price, String g_packunit,
			String g_packweight, String g_packlength, String g_packwidth,
			String g_packheight, String g_serial, String g_remarks,
			String g_time, String g_value) {
		super();
		this.g_id = g_id;
		this.cus_num = cus_num;
		this.g_class = g_class;
