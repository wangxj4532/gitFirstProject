 ...
 * 出入库管理模块——出库单明细VO
 *@author  孙军
 *2015年6月17日 上午10:18:18
 */
public class chrkgl_chukudanminxiVO {
	  ...
	  private String chkmxshp_name;                  /**出库明细商品名称**/
	...
	public String getChkmxshp_name() {
		return chkmxshp_name;
	}
	public void setChkmxshp_name(String chkmxshp_name) {
		this.chkmxshp_name = chkmxshp_name;
	}
	public chrkgl_chukudanminxiVO() {
	}
	public chrkgl_chukudanminxiVO(String chkhw_num, String chkmx_bill,
			String chkmxchkd_id, String chkhw, String chkmxshp_id,
			String chkmx_amount, String chkyxq, String chkshch_date,
			String chkmxshp_name) {
		this.chkhw_num = chkhw_num;
		this.chkmx_bill = chkmx_bill;
		this.chkmxchkd_id = chkmxchkd_id;
		this.chkhw = chkhw;
